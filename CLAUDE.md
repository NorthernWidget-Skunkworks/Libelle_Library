...
Arduino library for the NorthernWidget Libelle shortwave pyranometer.
...
This is a **sensor library**. Schema 1 migration is required once the spec is stable and a Schema 0 snapshot tag exists. Refer to the Libelle device appendix in [NW-Device-Specification](https://github.com/NorthernWidget/NW-Device-Specification) for the exact Page 1 register layout.
